...
class Pelicula(models.Model):
    ...
    director_pelicula = models.CharField(max_length=200, blank=False, null=False)
    sipnosis_pelicula = models.TextField(max_length=250, blank=False, null=False)
    duracion_pelicula = models.IntegerField(null=False, blank=False, default=0)
    fecha_estreno_pelicula = models.DateField(default=datetime.date.today)
